...
/**
 * One token every fifteen minutes: four an hour, 96 a day.
 *
 * The number is derived from Resend's documented free-plan daily cap of 100, not
 * chosen for feel. A steady-state rate that cannot exhaust the free allowance is
 * what makes "the owner still gets tomorrow's notifications" true after a flood.
 */
